...
import { Mail, Linkedin, Phone, Send, CheckCircle, Download } from "lucide-react";
...
export function Contact() {
  ...
  return (
    <div id="contact">
      ...
      {/* Contact form */}
      <ScrollReveal>
        <GlassCard rarity="rare" tilt={false} className="mb-8 p-6 md:p-8">
          {status === "sent" ? (
      ...
      <ScrollReveal>
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <a
            ...
            className="flex items-center gap-3 rounded-lg border border-accent bg-accent/10 p-4 transition-all hover:bg-accent/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/30"
          >
            <Download size={18} className="text-accent" aria-hidden="true" />
            <div>
              <div className="font-mono text-xs text-text-primary">Resume</div>
              <div className="font-mono text-[10px] text-text-muted">
                Download PDF
              </div>
            </div>
