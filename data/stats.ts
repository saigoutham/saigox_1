...
export const CHARACTER_STATS: CharacterStat[] = [
  {
    ...
    evidence: [
      ...
      "1PB+ data pipelines at Visa",
      "100M+ daily transactions processed",
    ],
    color: "#10b981",
  },
  {
  ...
  },
  {
    ...
    evidence: [
      ...
      "₹20L+ revenue with 94% YoY growth",
      "Cross-functional PM at Scopely",
    ],
    color: "#f59e0b",
  },
  {
    ...
    evidence: [
      ...
      "15K+ offer configurations automated",
      "40% faster turnaround, 30% fewer errors",
    ],
    color: "#ef4444",
  },
  {
    ...
    evidence: [
      ...
      "Subjects: tigers, leopards, elephants, birds",
      "Locations across Indian wilderness",
    ],
    color: "#a855f7",
  },
];
